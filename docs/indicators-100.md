# 100 Technical Indicators — Reference

A compiled list of 100 popular technical indicators commonly used by professional
stock chartists and day traders.

Top day traders (the "best stock chartists") rarely use dozens at once. They
typically rely on price action + volume + 3–7 core indicators tailored to their
style (e.g., VWAP for intraday fair value, EMAs for trend, RSI/MACD for momentum,
Bollinger Bands for volatility). The list below draws from comprehensive expert
sources (including day-trading guides, Quantified Strategies' collection of 100+
backtested indicators, TradingView/StockCharts libraries, and professional
references) and focuses on those frequently cited for stocks and intraday trading.
Many are oscillators, overlays, or volume-based tools suited to short timeframes
(1–15 min charts).

Indicators are grouped loosely into categories for easier reference (with some
overlap, as many serve multiple purposes). Variations (e.g., different moving
average types) are included because pros customize periods and types heavily.

---

## Volume & Money Flow (Key for Day-Trading Confirmation)

1. Volume (raw bars / relative volume)
2. VWAP (Volume Weighted Average Price) — the #1 intraday benchmark
...
16. Market Facilitation Index (MFI)
17. Wave Volume
18. Relative Volume (RVOL)
19. Time Segmented Volume (TSV)
20. Volume Rate of Change (VROC)

## Trend & Moving Averages (Core for Direction)

1. Simple Moving Average (SMA)
2. Exponential Moving Average (EMA)
3. Weighted Moving Average (WMA)
4. Hull Moving Average (HMA)
5. Adaptive Moving Average (or ALMA / Jurik MA)
...
## Momentum & Oscillators (Overbought/Oversold & Reversals)
...
## Volatility & Other Overlays / Tools
...
## Support/Resistance & Specialized Day-Trading Tools
...
10. SuperTrend (already noted, but often paired with pivots/fibs for day trades)

---

## Quick Tips from Pro Day Traders

- **Core setup for most chartists:** VWAP + 9/20/50 EMA + Volume + RSI (or
  Stochastic) + Bollinger Bands.
- Always combine with pure **price action** (candlesticks, support/resistance,
  breakouts).
- Test on your specific timeframe and assets — backtesting shows no single
  indicator wins alone.
- Avoid "indicator overload"; the best chartists keep charts clean.
